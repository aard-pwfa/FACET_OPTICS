...
% Optic parameters
input.type   = 'axiramp'; % can choose from 'axicon', 'axilens', and 'kinoform'
input.R      = 20.0e3;    % illuminated radius of mask (microns)
input.f0     = 3e6;       % distance to axilens focus (microns) [if type==axilens or axiramp]
input.Dz     = 1e6;       % length of axilens focus (microns) [if type==axilens or axiramp]
...
input.f      = 4e6;       % focal length of lens [if type==lens]
...
input.zern_amp = 0;   % amplitude of aberation
