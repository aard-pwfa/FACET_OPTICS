...
input.zmin   = 3.75e6; % starting z position (microns)
input.zmax   = 4.25e6; % ending z position (microns)
...
% Optic parameters
input.type   = 'lens';    % can choose from 'axicon', 'axilens', and 'kinoform'
