...
input.illum  = 'mask'; % options are 'tophat' which is an order 30 super gaussian, . . . 
                         % 'gaussian', 'mask' which has a hard edge, and 'flat' which is an infinite beam
input.sigma  = 19.0e3;   % sigma of gaussian/super gaussian or radius of mask (microns)
...
%% Plot data
save_dir = 'plots/mask_axilens_3x1/';
save_bool = 1;
plot_window = 150;
